...
<form id="abts-test-form" method="post">
    ...
    <div class="abts-form-group">
        ...
        <input type="text" id="abts-current-url" name="current_url" placeholder="http://www.adevelopers.net" <?php if (isset($test->current_url)) { echo 'value="'.$test->current_url.'"'; } ?> required autocomplete="off" onkeyup="loadResults('abts-current-url','key')"  />
        <div id="key"></div>
    ...
    <div class="abts-form-group">
        ...
        <div id="abts-variants-container">
            ...
            <div class="abts-variant-item">
                <input type="text" name="variants[]" id="variant0" placeholder="http://www.adevelopers.net/product/page V#" <?php if(isset($variants) && isset($variants[0])) { echo 'value="'.$variants[0].'"'; } ?> onkeyup="loadResults('variant0','key1')" required="required" >
                <div id="key1"></div>
            ...
            <?php if (isset($variants)) {
                ...
                foreach ($variants as $k => $variant) {
					...
					?>
                        <div class="abts-variant-item">
                            <input type="text" name="variants[]" placeholder="Page Url" value="<?php echo $variant; ?>" onkeyup="loadResults('<?php echo $v?>','<?php echo $key?>')" id="<?php echo $v?>">
                            <button type="button" class="abts-remove-variant-btn">Remove</button>
...
function loadResults(fld,key){
		...
		var data ={ action: "post_tests_action",pid:cid,fd:fld,kd:key };
